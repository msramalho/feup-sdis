...
public class BackupChunk implements Runnable {
    ...
    public void run() {
        ...
        byte[] message = Message.create("PUTCHUNK %s %d %s %d %d %s", c.chunk, peerConfig.protocolVersion, peerConfig.id, c.fileId, c.chunkNo, c.replicationDegree, c.getFileMetadata());
